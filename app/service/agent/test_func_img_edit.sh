...
curl -X POST "http://localhost:8000/process-agent-openai" -H "Content-Type: application/json" -d '{
        ...
        {"role": "user", "content": [{"type": "image_url", "image_url": {"url": "https://test-content-public.tos-cn-shanghai.volces.com/agent/others/%E5%B7%B4%E5%8E%98%E5%B2%9B3.jpeg"}}]}, {"role": "user", "content": "帮我把大海改成沙漠"}],
        "user_id": "1"
        }'