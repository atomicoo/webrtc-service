...
"messages":[ 
        ...
        {"role": "user", "content": [{"type": "image_url", "image_url": {"url": "https://test-content-public.tos-cn-shanghai.volces.com/agent/others/%E5%B7%B4%E5%8E%98%E5%B2%9B3.jpeg"}}]}, {"role": "user", "content": "这个地方所在国家的首都今天天气怎么样？请对任务进行拆解一步一步来解决。"}],
        "user_id": "1"
        }'
